...
public class LineComparisonProblemUC2 {
    //Declaration
    public static double x1, x2, y1, y2, LengthofLine, LengthofLine2;
    public static void LengthofLine()
    {
        ...
        String s1=Double.toString(LengthofLine);
        String s2=Double.toString(LengthofLine2);
        System.out.println("equality of two lines using Equal method " + s1.equals(s2));
    }
    public static void main(String args[])
    {
        EmployeewageComputationProblemUC1.computeEmployeewage();
        LengthofLine();
    }
}
